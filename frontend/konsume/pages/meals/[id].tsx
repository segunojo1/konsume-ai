      ...
      <MainLayout fixedTopbar={true} topBarText='Eat with AI' topBarIcon='logo2' includeMarginTop={true}>
        <div className='flex justify-between w-full font-satoshi'>
          ...
          <div className="flex flex-col gap-7">
            ...
            <div className="relative w-fit">
              <Image src='/multipleline.svg' alt='multi line' height={141} width={98} className='w-[50px] md:w-[98px]  absolute bottom-0 top-0 my-auto left-11 -z-50' />
              <h1 className="md:text-desktop-heading4 text-[22px]/[120%] font-bold z-50">{id}</h1>
            </div>
            <p className=" text-desktop-content text-primarygtext italic max-w-[450px]">{mealDesc ? mealDesc : ".."} <b>Bon Appétit!</b></p>
            <div className='flex items-center gap-2'>

              <p className=' text-desktop-highlight font-medium'>Calories per serving: <span className='text-[#FFC501]'>{numberOfCalories ? numberOfCalories : ".."}</span> kcal </p><Image src="/breakfast.svg" alt='' width={27.6} height={27.6} />
            </div>
          </div>
        ...
        <div className='flex gap-20 items-center justify-between md:mt-10 mb-16'>
          ...
          <Button className='border-2 border-[#0C2503] flex px-3 py-3 h-full gap-3 rounded-lg font-satoshi'>
            <Image alt='cookmode' width={27.6} height={27.6} src='/cookmode.svg' />
            <p className='text-primarygtext text-desktop-content font-bold xl:block hidden'>Open Cook Mode</p>
          </Button>
        </div>
