...
const BioData = () => {
  const { nextPage, age, setAge, height, setHeight, weight, setWeight, gender, setGender } = useSetupContext();
  const checkForm = () => {};
  ...
  return (
    <div className="mt-12">
      <div className="imgg_container">
        <h1 className=" font-bold text-4xl leading-[73px]">Basic Information</h1>
          ...
          <Form {...form}>
            ...
            >
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-sm md:text-xl font-medium !leading-10">Date of birth</FormLabel>
                    <FormControl>
                      <Input
                        type="date"
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="">
                    <FormLabel className="text-sm md:text-xl font-medium !leading-10">Height - m</FormLabel>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-sm md:text-xl font-medium !leading-10">Gender</FormLabel>
                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                      ...
                      <SelectContent ref={field.ref} className="bg-[#D6FBC4] py-[5.5px] px-16 w-full">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="">
                    <FormLabel className="text-sm md:text-xl font-medium !leading-10">Weight - kg</FormLabel>
                    <FormControl className="">
                      <Input
                        placeholder="Input your height"
                        {...field}
