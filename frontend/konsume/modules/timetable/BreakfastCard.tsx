...
const BreakfastCard = () => {
    return (
        <div className='flex flex-col items-start gap-9 py-6 px-3 shadow-sm rounded-[34px] hover:shadow-lg'>
            <div
                className="justify-between flex flex-col min-h-[130px] bg-primary-bg-100 px-3 pt-3 relative rounded-lg "
            >
