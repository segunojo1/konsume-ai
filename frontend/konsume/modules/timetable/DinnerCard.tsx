...
const DinnerCard = () => {
  return (
    <div className='flex flex-col items-start gap-9 py-6 px-3 shadow-sm rounded-[34px] bg-primary-bg hover:shadow-lg'>
            <div
                className="justify-between flex flex-col min-h-[130px] bg-color8-100 px-3 pt-3 relative rounded-lg "
            >
                <div className="flex justify-between">
                    <p className="text-primarygtext font-bold text-mobile-caption">Dinner</p>
                </div>
