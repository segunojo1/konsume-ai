...
const ScannerBody = () => {
  ...
  return (
    <div>
      <div className="border-[2.6px] border-[#BEFFA7] flex flex-col md:flex-row gap-3 items-center justify-center bg-[#E0F6EF] md:w-[450px] py-6 rounded-[19.7px] mx-auto font-jakarta">
        {image !== "" && (
          <Image
            src={image}
            width={150}
      ...
      <p>
        Result: {loading ? <LoaderCircle className=" animate-spin" /> : result}
      </p>
    </div>
  );
};
