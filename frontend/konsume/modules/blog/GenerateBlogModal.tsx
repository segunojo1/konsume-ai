...
const GenerateBlogModal = () => {
    ...
    return (
        <div className='flex items-center justify-center mx-auto top-0 left-0 right-0 bottom-0 fixed backdrop-blur-md'>
            <div className='bg-base-white flex flex-col z-[70] p-10  backdrop-blur-md rounded-[10px] shadow-sm relative'>
                ...
                <p className='text-desktop-content my-8 w-[448px]'>Type in a keyword or phrase related to nutrition, meals, or goals. Our AI will generate a detailed blog based on your input.</p>
