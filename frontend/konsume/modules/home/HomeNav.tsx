  ...
  return (
    <div className="flex items-center justify-between mb-[232px] 2xl:px-[90px] md:px-[30px] px-[19px] pt-[51px] z-[99999]">
      ...
      <SelectContent className="bg-[transparent] gap-2 flex flex-col shadow-none">
          <SelectItem value="personal" className="rounded-3xl bg-[white] w-fit pr-8 mb-1">Personal</SelectItem>
          <SelectItem value="restaurant" className="rounded-3xl bg-[white] w-fit pr-8">Restaurant</SelectItem>
