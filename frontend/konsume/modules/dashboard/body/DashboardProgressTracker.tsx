  ...
  return (
    <div className="mb-8 h-full md:mb-0 max-w-[299px] flex-[.5] flex min-w-full flex-col justify-between bg-primary-bg-100 p-4 rounded-2xl js-tilt mealreco">
      ...
      <div className="flex justify-between items-center">
        ...
        <h1 className="text-[20px] font-bold p-5">03</h1>
      </div>
        <h1 className="text-[14px] font-bold text-primarygtext">Total Goal Streak: <span className="text-neutrals-100">X</span> days of commitment</h1>
    </div>
  );
};
